# Importing Packages
import json
from chunking import load_and_chunk_dataset
from chroma_store import build_chroma_collection, delete_documents_with_keyword
...
if __name__ == "__main__":
	...
	# Now delete all documents containing the keyword "Banana".
	keyword = "Banana"
